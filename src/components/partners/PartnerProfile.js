					...
					<table className='table table-striped table-hover table-sm' ref='main'>
						...
						<tbody>
							<tr>
								...
								{partner.status === 'approved' && <td><span className="text-info">Partner Created</span></td>}
								{partner.status === 'processing' && <td><span className="btn btn-primary" onClick={() => this.callPartnerConfirm(partner.id)}>Confirm</span></td>}
							</tr>
						</tbody>
					</table>
				</div>
