...
const SearchDetails = ({
	...
	return ( <
		...
		div className = '' >
		<
		span className = 'text-bold px-2' > {
			`${details.strSectorFrom}`
		} < /span> <
		i className = {
			details.strTripType === 'O' ? 'fas fa-arrow-right' : 'fas fa-exchange-alt'
		}
		/> <
		span className = 'text-bold px-2' > {
			`${details.strSectorTo}`
		...
		<
		i class = 'fas fa-plane departure text-primary' / > & nbsp; {
		...
		/span> {
			details.strTripType === 'R' && ( <
				span className = 'text-small text-muted px-2' >
				<
				i className = 'fas fa-plane arrival text-primary' / > & nbsp; {
		...
		span className = 'text-small text-muted px-2' >
		<
		i className = 'fas fa-male text-primary' / > & nbsp; {
			details.intAdult
		}
		Adult {
		...
		/span> <
		span className = 'btn text-primary bg-none'
		onClick = {
			onModify
		} >
		<
