				...
				<section className='bg-primary text-center'>
					<div className='container'>
						...
						<input
							...
							className='w-100'
							onChange={(e) => this.fetchFaqs(`q[question_cont]=${e.target.value}`)}
						/>
					</div>
				</section>
							...
							<div className='d-flex'>
								<div className='widget p-2'>
									<div className='text-center'>
										...
										<h3 className='count' onClick={() => this.fetchFaqs(`q[category_eq]=flight`)}>
											Flights
										</h3>
									</div>
								</div>
								<div className='widget p-2'>
									<div className='text-center'>
										...
										<h3 className='count' onClick={() => this.fetchFaqs(`q[category_eq]=package`)}>
											Packages
										</h3>
									</div>
								</div>
