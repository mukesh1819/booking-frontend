    ...
    <div className="container-fluid">
        <div className="col-md-6 ml-auto mr-auto" id="search-form pdf-mar">
            <div className="d-flex justify-content-between">
                ...
                <div className=""><Image width="35px" height="37px" src={booking.airline_logo} />
        ...
        <div className="col-md-6">
            <div className="offset-4 col-4 p-3">
                <a href={`/${booking.ruid}/download_ticket.pdf`} className="btn btn-success view-font ml-5">Print ticket</a>
            </div>
        </div>
    </div>
</React.Fragment>
