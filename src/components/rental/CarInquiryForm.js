...
class CarInquiryForm extends Component {
    ...
    render() {
        ...
        if (inquiryDetails.car_type) {
            vehicle_max_pax = vehicles.find(
                (v) => v.name == inquiryDetails.car_type
            );
                                        ...
                                        {!values.within_city && (
                                            <div className="field-box col">
                                                ...
                                                <Dropdown
                                                    ...
                                                    options={locations
                                                        .filter((v) => {
                                                            var predicate = values.airport_dropoff
                                                                ? "airport"
                                                                : "city";
                                                            return (
                                                                v.location_type ==
                                    ...
                                    <div className="inputs row">
                                        ...
                                        <div className="field-box col">
                                            ...
                                            <Dropdown
                                                ...
                                                selection
                                                closeOnChange={false}
                                                placeholder={"Traveller".pluralize(
                                                    values.no_of_pax
                                                )}
                                                onClick={(event, data) => {
                                                    event.preventDefault();
